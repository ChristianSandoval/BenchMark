...
//    private ScriptObject scriptobjinst;
    ...
    private boolean closeTicket(TicketInfo ticket, Object ticketext) {
        ...
        /*boolean esDesayuno = false;
        for(int i=0; i<m_oTicket.getLinesCount();i++)
        {
            if(m_oTicket.getLine(i).getProductCategoryID().equalsIgnoreCase("f1dc0222-a0ea-44da-a118-016f3b5f9318"))
            {
                esDesayuno = true;
                break;
            }
        ...
        for(int i=0; i<m_oTicket.getLinesCount();i++)
        {
            if(m_oTicket.getLine(i).getProductID().equalsIgnoreCase("1")&&m_oTicket.getCustomer()==null)
            {
                JOptionPane.showMessageDialog(this, "Para vender este producto debes seleccionar un comensal.");
                return false;
            }
            if(m_oTicket.getLine(i).getProductID().equalsIgnoreCase("1")&&m_oTicket.getCustomer()!=null)
            {
                k++;
                try {
                    if(dlSales.isConsumoEmpleado(m_oTicket.getCustomerId()))
                    {
                        JOptionPane.showMessageDialog(this, "Este empleado ya realizo un consumo este dia.");
                        return false;
                    }
                } catch (BasicException ex) {
                    Logger.getLogger(JPanelTicket.class.getName()).log(Level.SEVERE, null, ex);
        ...
        if(k>1)
        {
            JOptionPane.showMessageDialog(this, "No puedes vender mas de una comida a credito");
            return false;
        }*/
...
/** This method is called from within the constructor to
    ...
    private void initComponents() {
        ...
        m_jButtons.setPreferredSize(new java.awt.Dimension(930, 62));
        m_jButtons.setRequestFocusEnabled(false);

        m_jDelete3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/reload.png"))); // NOI18N
        m_jDelete3.setFocusPainted(false);
        m_jDelete3.setFocusable(false);
        m_jDelete3.setMargin(new java.awt.Insets(8, 14, 8, 14));
        m_jDelete3.setPreferredSize(new java.awt.Dimension(63, 62));
        ...
        m_jButtons.add(m_jDelete3);

        m_jTicketId.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        m_jTicketId.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        m_jTicketId.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createLineBorder(javax.swing.UIManager.getDefaults().getColor("Button.darkShadow")), javax.swing.BorderFactory.createEmptyBorder(1, 4, 1, 4)));
        m_jTicketId.setOpaque(true);
        m_jTicketId.setPreferredSize(new java.awt.Dimension(300, 50));
        m_jTicketId.setRequestFocusEnabled(false);
        m_jButtons.add(m_jTicketId);

        m_jDelete1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/desktop.png"))); // NOI18N
...
if ((this.m_oTicket.getLinesCount() > 0))
    ...
    JTextField deuda = new JTextField("1000000.00");
    mensajeList.add(deuda);
    
    mensajeList.add(new JLabel("Clave*: "));
    JTextField telefono = new JTextField();
    mensajeList.add(telefono);
...
int i = m_ticketlines.getSelectedIndex();
        if (i < 0){
            ...
            m_oTicket.getLine(i).setProperty("comentario", com);
        }
        refreshTicket();
    ...
    private void m_jDelete3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jDelete3ActionPerformed
        String mesa=JOptionPane.showInputDialog("Mesa");
        m_jTicketId.setText(mesa);
        m_oTicket.setProperty("mesa", mesa);
